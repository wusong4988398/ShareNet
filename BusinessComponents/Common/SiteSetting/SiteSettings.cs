...
namespace ShareNet.Common.Common.SiteSetting
{
    public class SiteSettings
    {
        ...
        public class SiteSetting : IEntity
        {
            ...
            private string statScript = string.Empty;
            ...
            private string defaultSiteName = "近乎";
            ...
            private string defaultSiteDescription = "基于asp.net mvc 最强大SNS社区软件";
            ...
            private string searchMetaDescription =
                "“近乎”是一款业内领先的SNS社区软件。借助预置的微博、群组、日志、相册、贴吧、问答等应用模块，可以帮助客户快速搭建以用户为中心、用户乐于贡献内容、互动无处不在、易于运营的社区网站。它采用了业内领先的技术体系架构、隐私保护功能、用户评价体系、优异的缓存技术、全文检索技术。可以承载千万级的数据，具备优异的扩展性并提供丰富的API，方便用户进行定制开发或者二次开发。";
            ...
            private string searchMetaKeyWords = "近乎,SNS社区软件处不在、易于运营的社区网站。";
            ...
            private string siteTheme = "Default";
            ...
            {
                get { return typeof (SiteSettings).FullName; }
            }
