...
using ShareNet.Common.User.Role;
...
namespace ShareNet.Common.User.Account.Configuration
{
    ...
    {
        private RegistrationMode registrationMode = RegistrationMode.All;
        /// <summary>
        /// 用户注册方式设置
        /// </summary>
        ...
        AccountActivation accountActivation = AccountActivation.Automatic;
        ...
        string phoneRegex = @"^(13|14|15|18)[0-9]{9}$";
        /// <summary>
        /// 手机号验证正则表达式
        /// </summary>
        ...
        public object EntityId { get { return typeof (UserSettings).FullName; }}
