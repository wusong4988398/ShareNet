   ...
   public class CaptchaSettings
    {
        ...
        private string enablePhone = string.Empty;
        ...
        public bool EnablePhone
        {
            get
            {
                if (enablePhone.Equals("Enable", StringComparison.InvariantCultureIgnoreCase))
                    return true;
                return false;
            }
        }
        ...
        private CaptchaSettings()
        {
            ...
            if (ConfigurationManager.AppSettings.AllKeys.Contains("Phone:Enable"))
                enablePhone = ConfigurationManager.AppSettings["Phone:Enable"].ToString();
