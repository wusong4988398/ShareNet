...
namespace ShareNet.Common.User
{
    ...
    public class User : IUser, IEntity
    {
        ...
        public static User New(long userId, string username, string accountEmail, string accountMobile)
        {
            ...
            user.Rank = 1;
            user.DateAvatar = DateTime.UtcNow.Ticks;
            return user;
        }
        ...
        /// 上传头像时间
        /// </summary>
        private long dateAvatar = DateTime.UtcNow.Ticks;
        public long DateAvatar
        {
            get { return dateAvatar; }
            set { dateAvatar = value; }
        }
        ...
        //        IEnumerable<string> dataKeys = OwnerDataSettings.GetDataKeys(tenantTypeId).Where(n => !n.StartsWith("PointMall"));
